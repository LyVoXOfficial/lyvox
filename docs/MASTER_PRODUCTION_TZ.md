...
- [x] ~~**17.** `PERF-05` + `PERF-06` — дедуп запросов главной + `React.cache()` сессии + бюджет бандла~~ ✅ 2026-07-06 — 🎚️ **[Sonnet 5 · medium]**
