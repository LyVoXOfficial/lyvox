...
- [ ] **17b.** `PERF-07` — догнать остальной bundle-bloat (Sentry lazy-init ~69kB / login-zod ~59kB / search FormRenderer ~24kB / trust-gate body ~17kB); каждый — не behavior-identical, со своим замером — 🎚️ **[Sonnet 5 · medium]** (Sentry — Opus·high)
...
### PERF-07 · Догнать остальной bundle-bloat (из аудита 2026-07-07) — [P2][⛔] — не behavior-identical, каждый пункт со своим замером
