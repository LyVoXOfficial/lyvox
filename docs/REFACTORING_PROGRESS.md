> [!WARNING]
> **Архивный отчёт о рефакторинге. Не использовать проценты и статусы ниже как текущие.** Актуальный технический backlog находится только в [`docs/MASTER_PRODUCTION_TZ.md`](./MASTER_PRODUCTION_TZ.md). Файл сохранён как история.
