> [!NOTE]
> **Архивный исследовательский план.** Использовать только как исторический контекст; актуальные UX-задачи и критерии приёмки находятся в [`docs/MASTER_PRODUCTION_TZ.md`](./MASTER_PRODUCTION_TZ.md).
