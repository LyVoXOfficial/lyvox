...
Кодовая база уже ближе к продукту, чем старые архивные документы показывают.
...
- Вести текущий статус только в `docs/MASTER_PRODUCTION_TZ.md`.
...
- Keep current chat/billing/notifications/fraud status only in `docs/MASTER_PRODUCTION_TZ.md`.
