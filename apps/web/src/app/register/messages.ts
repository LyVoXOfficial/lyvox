...
const englishMessages: RegisterMessages = {
  ...
  heroSubtext: "Verified email and phone signals. Clear seller labels. Reporting and moderation tools.",
  heroSignal1: "Email & phone verification",
  heroSignal2: "Private & business labels",
  heroSignal3: "Report and moderation tools",
...
export const registerMessages: Record<Locale, RegisterMessages> = {
  ...
  fr: {
    ...
    heroSubtext: "Signaux email et telephone verifies. Labels vendeurs clairs. Outils de signalement et moderation.",
    heroSignal1: "Verification email et telephone",
    heroSignal2: "Labels prive et professionnel",
    heroSignal3: "Signalement et moderation",
  ...
  nl: {
    ...
    heroSubtext: "Geverifieerde e-mail- en telefoonsignalen. Duidelijke verkoperlabels. Meld- en moderatietools.",
    heroSignal1: "E-mail- en telefoonverificatie",
    heroSignal2: "Prive en zakelijke labels",
    heroSignal3: "Melden en moderatie",
  ...
  ru: {
    ...
    heroSubtext: "Проверка email и телефона. Чёткие метки продавцов. Инструменты жалоб и модерации.",
    heroSignal1: "Проверка email и телефона",
    heroSignal2: "Метки частных и бизнес-продавцов",
    heroSignal3: "Жалобы и модерация",
  ...
  de: {
    ...
    heroSubtext: "Verifizierte E-Mail- und Telefonsignale. Klare Verkaeuferkennzeichnung. Melde- und Moderationswerkzeuge.",
    heroSignal1: "E-Mail- und Telefonverifizierung",
    heroSignal2: "Privat- und Geschaeftslabels",
    heroSignal3: "Melden und Moderation",
