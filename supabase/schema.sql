...
CREATE TABLE public.vehicle_generations (
  ...
  CONSTRAINT vehicle_generations_model_id_fkey FOREIGN KEY (model_id) REFERENCES public.vehicle_models(id)
);
CREATE TABLE public.vehicle_insights (
  ...
  CONSTRAINT vehicle_insights_pkey PRIMARY KEY (model_id),
  CONSTRAINT vehicle_insights_model_id_fkey FOREIGN KEY (model_id) REFERENCES public.vehicle_models(id)
);
...
CREATE TABLE public.vehicle_models (
  ...
  CONSTRAINT vehicle_models_make_id_fkey FOREIGN KEY (make_id) REFERENCES public.vehicle_makes(id)
);